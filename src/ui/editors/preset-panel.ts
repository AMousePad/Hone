...
import { makeSection, makeDescription, makeSelectRow, makeToggleRow, generatePromptId } from "../forms";
  ...
  function handleBackendMessage(msg: BackendToFrontend): boolean {
    switch (msg.type) {
      ...
      case "preset": {
        ...
        if (optimisticPresetId === incoming.id) return true;
